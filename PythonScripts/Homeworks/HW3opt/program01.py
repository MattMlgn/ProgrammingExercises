...
def ex1(text_file, min_len, max_len, n):
    # print(KMPSearch(
    #   "10101", computeFile(text_file)))
    s = computeFile(text_file)
    most_frequent = max(set(s),
                        key=s.count)

    print(most_frequent, "is repeated: ", s.count(most_frequent), " times.")
